...
void PopulateCities()
{
    ...
    CreateCity("Bourges", "France", 47.0806, 2.39893);
    ...
    CreateCity("Civaux", "France", 46.4448, 0.664645);
    ...
    CreateCity("Esbjerg", "Denmark", 55.4665, 8.45208);
    ...
    CreateCity("Frederikshavn", "Denmark", 57.4412, 10.5336);
    CreateCity("Gdańsk", "Poland", 54.3614, 18.6282);
    CreateCity("Gedser", "Denmark", 54.5761, 11.9322);
    ...
    CreateCity("Golfech", "France", 44.1147, 0.851944);
    ...
    CreateCity("Hirtshals", "Denmark", 57.5908, 9.96497);
    ...
    CreateCity("Kapellskär", "Sweden", 59.7204, 19.0608);
    ...
    CreateCity("Kunda", "Estonia", 59.5055, 26.5292);
    ...
    CreateCity("Loviisa", "Finland", 60.4562, 26.2268);
    ...
    CreateCity("Mažeikiai", "Lithuania", 56.3116, 22.3383);
    ...
    CreateCity("Naantali", "Finland", 60.4689, 22.0291);
    CreateCity("Nantes", "France", 47.2186, -1.55414);
    CreateCity("Napoli", "Italy", 40.8359, 14.2488);
    CreateCity("Narva", "Estonia", 59.3794, 28.1994);
    ...
    CreateCity("Nynäshamn", "Sweden", 58.9056, 17.9471);
    CreateCity("Odense", "Denmark", 55.3997, 10.3852);
    CreateCity("Olkiluoto", "Finland", 61.2341, 21.4906);
    ...
    CreateCity("Roscoff", "France", 48.7256, -3.98292);
    CreateCity("Rostock", "Germany", 54.0924, 12.1286);
    CreateCity("Rotterdam", "Netherlands", 51.9278, 4.48862);
    CreateCity("Saint-Alban-du-Rhône", "France", 45.4243, 4.76);
    CreateCity("Saint-Laurent", "France", 47.9267, -3.92795);
    ...
    CreateCity("Södertälje", "Sweden", 59.1964, 17.6272);
    CreateCity("Sosnovy Bor", "Russia", 59.8778, 29.1306);
    ...
    CreateCity("Suzzara", "Italy", 44.9919, 10.7431);
    ...
    CreateCity("Terni", "Italy", 42.5641, 12.6405);
    CreateCity("Torino", "Italy", 45.0678, 7.68249);
    CreateCity("Toulouse", "France", 43.6045, 1.44425);
    CreateCity("Travemünde", "Germany", 53.9396, 10.8588);
    CreateCity("Trelleborg", "Sweden", 55.3759, 13.1462);
    CreateCity("Turku", "Finland", 60.4518, 22.2671);
    CreateCity("Uppsala", "Sweden", 59.8594, 17.6411);
    CreateCity("Utena", "Lithuania", 55.4984, 25.6026);
    ...
    CreateCity("Ventspils", "Latvia", 57.3904, 21.5636);
    CreateCity("Verona", "Italy", 45.4385, 10.9924);
    CreateCity("Villa San Giovanni", "Italy", 38.2201, 15.6374);
    CreateCity("Vilnius", "Lithuania", 54.687, 25.2829);
    CreateCity("Vyborg", "Russia", 60.7092, 28.7441);
...
void CreateCity(const char* Name, const char* InCountry, double Lat, double Lon)
{
    for(uint i = 0; i < Countries.size(); i++)
    {
        ...
        {
            City ReturnCity(Name, Countries[i], Lat, Lon);
